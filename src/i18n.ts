...
const DESKTOP_UI_TEXT: Record<AppLanguage, Record<string, string>> = {
  "zh-CN": {
    ...
    "cost.cached": "（缓存）",
    "cost.insufficient": " · 余额不足，执行时会被阻止",
    ...
    "prompt.translatePartialFailed": "部分中文翻译失败，已尽力翻译；可点还原",
    "prompt.translateDone": "已翻译中文标签（英文保留），可点还原",
  ...
  "zh-TW": {
    ...
    "cost.cached": "（快取）",
    "cost.insufficient": " · 餘額不足，執行時會被阻止",
    "account.configured": "已配置 API",
    ...
    "prompt.translatePartialFailed": "部分中文翻譯失敗，已盡力翻譯；可點還原",
    "prompt.translateDone": "已翻譯中文標籤（英文保留），可點還原",
  ...
  "en-US": {
    ...
    "cost.cached": " (cached)",
    "cost.insufficient": " · insufficient balance; the run will be blocked",
    ...
    "prompt.translatePartialFailed": "Some Chinese segments failed to translate; restored what could be translated. You can revert.",
    "prompt.translateDone": "Translated Chinese tags; English tags were kept. You can revert.",
  ...
  "ja-JP": {
    ...
    "cost.cached": "（キャッシュ）",
    "cost.insufficient": " · 残高不足のため実行時にブロックされます",
    ...
    "prompt.translatePartialFailed": "一部の中国語翻訳に失敗しました。可能な範囲で翻訳済みです。元に戻せます",
    "prompt.translateDone": "中国語タグを翻訳しました（英語は保持）。元に戻せます",
  ...
  "ko-KR": {
    ...
    "cost.cached": "(캐시)",
    "cost.insufficient": " · 잔액 부족, 실행 시 차단됩니다",
    ...
    "prompt.translatePartialFailed": "일부 중국어 번역에 실패했습니다. 가능한 만큼 번역했으며 되돌릴 수 있습니다",
    "prompt.translateDone": "중국어 태그를 번역했습니다(영어는 유지). 되돌릴 수 있습니다",
...
const DESKTOP_SETTINGS_UI_TEXT: Record<AppLanguage, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.translateHint": "提示词“中→英翻译”按钮使用的翻译引擎。",
  ...
  "zh-TW": {
    ...
    "settings.translateHint": "提示詞「中→英翻譯」按鈕使用的翻譯引擎。",
  ...
  "en-US": {
    ...
    "settings.translateHint": "Translation engine used by the prompt Chinese→English button.",
  ...
  "ja-JP": {
    ...
    "settings.translateHint": "プロンプトの中国語→英語ボタンで使う翻訳エンジンです。",
  ...
  "ko-KR": {
    ...
    "settings.translateHint": "프롬프트 중국어→영어 버튼이 사용할 번역 엔진입니다.",
