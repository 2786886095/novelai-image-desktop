...
const DESKTOP_EXTRA_UI_TEXT: Record<AppLanguage, Record<string, string>> = {
  "zh-CN": {
    ...
    "promptCodex.convertHint": "根据输入从本地法典检索相关规范和 Tag，并注入同一次转换请求。",
  ...
  "zh-TW": {
    ...
    "promptCodex.convertHint": "依輸入從本機法典檢索相關規範與 Tag，並注入同一次轉換請求。",
  ...
  "en-US": {
    ...
    "promptCodex.convertHint": "Retrieves relevant local rules and tags from the input and injects them into the same conversion request.",
  ...
  "ja-JP": {
    ...
    "promptCodex.convertHint": "入力から関連するローカル規則とTagを検索し、同じ変換リクエストに追加します。",
  ...
  "ko-KR": {
    ...
    "promptCodex.convertHint": "입력에서 관련 로컬 규칙과 Tag를 검색해 같은 변환 요청에 주입합니다.",
