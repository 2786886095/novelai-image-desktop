...
const GENERATE_PANEL_TEXT = {
  "zh-CN": {
    ...
    prompt: {
      ...
      stylePresetImageHint: "点击图片可全屏预览；每个风格最多保存 9 张。",
  ...
  "zh-TW": {
    ...
    prompt: {
      ...
      stylePresetImageHint: "點擊圖片可全螢幕預覽；每個風格最多保存 9 張。",
  ...
  "en-US": {
    ...
    prompt: {
      ...
      stylePresetImageHint: "Click an image for full-screen preview. Up to 9 images per style.",
  ...
  "ja-JP": {
    ...
    prompt: {
      ...
      stylePresetImageHint: "画像をクリックすると全画面表示します。各スタイル最大9枚。",
  ...
  "ko-KR": {
    ...
    prompt: {
      ...
      stylePresetImageHint: "이미지를 두 번 클릭하면 전체 화면으로 볼 수 있습니다. 스타일당 최대 9장입니다.",
