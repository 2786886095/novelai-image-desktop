...
contextBridge.exposeInMainWorld("naiDesktop", {
  ...
  exportFiles: (files: BatchExportFile[], defaultName?: string) => ipcRenderer.invoke("storage:exportFiles", files, defaultName),
  ...
  addConvertHistoryItem: (item: TextToolHistoryItem) => ipcRenderer.invoke("texttool:addConvertHistoryItem", item),
  deleteConvertHistoryItem: (id: string) => ipcRenderer.invoke("texttool:deleteConvertHistoryItem", id),
  ...
  addReverseHistoryItem: (item: TextToolHistoryItem) => ipcRenderer.invoke("texttool:addReverseHistoryItem", item),
  deleteReverseHistoryItem: (id: string) => ipcRenderer.invoke("texttool:deleteReverseHistoryItem", id),
  clearReverseHistory: () => ipcRenderer.invoke("texttool:clearReverseHistory"),
  pruneMissingReverseHistoryItem: (id: string) => ipcRenderer.invoke("texttool:pruneMissingReverseHistoryItem", id),
