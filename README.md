...
[![Release](https://img.shields.io/badge/release-v2.2.3-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v2.2.3)
...
- **v2.2.3 中国大陆线路**：[Gitee Releases](https://gitee.com/langbai666/novelai-image-desktop/releases#release-v2.2.3)
- **v2.2.3 全球线路**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v2.2.3)
...
| 平台 | 文件 |
| --- | --- |
| Windows（便携版） | `Langbai-NovelAI-Studio-2.2.3.exe` |
| Windows（安装版） | `Langbai-NovelAI-Studio-Setup-2.2.3.exe` |
...
```text
release\Langbai-NovelAI-Studio-2.2.3.exe          # 便携版
release\Langbai-NovelAI-Studio-Setup-2.2.3.exe    # 安装版（NSIS 向导）
