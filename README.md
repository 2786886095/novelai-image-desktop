...
[![Release](https://img.shields.io/badge/release-v0.8.0-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.0)
...
- **v0.8.0 正式版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.0)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-0.8.0.exe` |
...
```text
release\Langbai-NovelAI-Studio-0.8.0.exe
