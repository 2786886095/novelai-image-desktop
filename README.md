...
[![Release](https://img.shields.io/badge/release-v1.2.0-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.2.0)
...
- **v1.2.0 本地版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.2.0)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-1.2.0.exe` |
...
```text
release\Langbai-NovelAI-Studio-1.2.0.exe
