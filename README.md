...
下面是仓库已有的 **2026-08-30 / v2.0.1 实际界面截图**，用于展示布局；v2.3.6 已增加酒馆等入口，具体功能以当前版本为准。顶部芙宁娜配图是宣传插画，不作为功能截图。
...
以下直链对应 **[v2.3.6](https://github.com/2786886095/novelai-image-desktop/releases/tag/v2.3.6)**；后续版本请使用上面的「最新发行版」。

| 平台 | 选择安装包 | 使用说明 |
| --- | --- | --- |
| Windows x64 · 安装版 | [Setup.exe](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/Langbai-NovelAI-Studio-Setup-2.3.6.exe) | 长期使用建议选这个；安装向导、快捷方式、软件内更新 |
| Windows x64 · 便携版 | [便携版.exe](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/Langbai-NovelAI-Studio-2.3.6.exe) | 双击运行；启动时解压到临时目录，更新需下载新包替换 |
| macOS · Intel / Apple 芯片 | [通用 DMG](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/Langbai-NovelAI-Studio-2.3.6-universal.dmg) / [ZIP](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/Langbai-NovelAI-Studio-2.3.6.zip) | 当前未签名；安装与系统提示处理见[安装说明](./docs/guide/GETTING_STARTED.md#install) |
| Linux x64 | [AppImage](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/Langbai-NovelAI-Studio-2.3.6.AppImage) | 添加执行权限后运行 |
| Android | [APK](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/app-release.apk) | 手动安装 APK |
| iOS | [未签名 IPA](https://github.com/2786886095/novelai-image-desktop/releases/download/v2.3.6/novelai-mobile-unsigned.ipa) | 需要自行签名或侧载，不是 App Store 安装包 |

**v2.3.6 同步更新电脑端与手机端；iOS 附件为未签名测试包。**
