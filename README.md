...
[![Release](https://img.shields.io/badge/release-v1.2.5-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.2.5)
...
- **v1.2.5 本地版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.2.5)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-1.2.5.exe` |
...
```text
release\Langbai-NovelAI-Studio-1.2.5.exe
