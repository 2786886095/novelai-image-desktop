...
[![Release](https://img.shields.io/badge/release-v0.8.2-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.2)
...
- **v0.8.2 正式版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.2)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-0.8.2.exe` |
...
```text
release\Langbai-NovelAI-Studio-0.8.2.exe
