...
[![Release](https://img.shields.io/badge/release-v1.1.6-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.1.6)
...
- **v1.1.6 本地版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.1.6)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-1.1.6.exe` |
...
```text
release\Langbai-NovelAI-Studio-1.1.6.exe
