...
[![Release](https://img.shields.io/badge/release-v0.7.9-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.7.9)
...
- **v0.7.9 正式版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.7.9)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-0.7.9.exe` |
...
```text
release\Langbai-NovelAI-Studio-0.7.9.exe
