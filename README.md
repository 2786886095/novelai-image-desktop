...
[![Release](https://img.shields.io/badge/release-v0.8.1-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.1)
...
- **v0.8.1 正式版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v0.8.1)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-0.8.1.exe` |
...
```text
release\Langbai-NovelAI-Studio-0.8.1.exe
