...
[![Release](https://img.shields.io/badge/release-v1.0.1-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.0.1)
...
- **v1.0.1 本地版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.0.1)
...
| 平台 | 文件 |
| --- | --- |
| Windows | `Langbai-NovelAI-Studio-1.0.1.exe` |
...
```text
release\Langbai-NovelAI-Studio-1.0.1.exe
