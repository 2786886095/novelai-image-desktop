...
[![Release](https://img.shields.io/badge/release-v1.6.6-7c5cfa.svg)](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.6.6)
...
- **v1.6.6 本地版**：[GitHub Releases](https://github.com/2786886095/novelai-image-desktop/releases/tag/v1.6.6)
...
| 平台 | 文件 |
| --- | --- |
| Windows（便携版） | `Langbai-NovelAI-Studio-1.6.6.exe` |
| Windows（安装版） | `Langbai-NovelAI-Studio-Setup-1.6.6.exe` |
...
```text
release\Langbai-NovelAI-Studio-1.6.6.exe          # 便携版
release\Langbai-NovelAI-Studio-Setup-1.6.6.exe    # 安装版（NSIS 向导）
